      ...
      >
        <script
          dangerouslySetInnerHTML={{
            __html: `try{var t=localStorage.getItem('verya-theme');if(t==='dark'||(!t&&window.matchMedia('(prefers-color-scheme: dark)').matches)){document.documentElement.classList.add('dark')}}catch(e){}`,
          }}
        />
        {children}
      </body>
